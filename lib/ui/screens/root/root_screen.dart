                ...
                children: [
                  InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(
                          "assets/Icons_assets/homeLogo.png", scale: 4,
                          color: model.selectedIndex == 0 ? Colors.blue : Colors
                              .white,),
                        SizedBox(height: 5,),
                        Text("Home", style: TextStyle(color: model
                  ...
                  InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          "assets/Icons_assets/workoutLogo.png", scale: 4,
                          color: model.selectedIndex == 1 ? Colors.blue : Colors
                              .white,),
                        SizedBox(height: 5,),
                        Text("Workout", style: TextStyle(color: model
                  ...
                  InkWell(
                    ...
                    child: Column(
                      ...
                      children: [
                        Image.asset(
                          "assets/Icons_assets/profileLogo.png", scale: 4,
                          color: model.selectedIndex == 2 ? Colors.blue : Colors
                              .white,),
                        SizedBox(height: 5,),
                        Text("Profile", style: TextStyle(color: model
